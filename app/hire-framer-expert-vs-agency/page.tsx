...
const config: ComparisonConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes for marketing sites. UpdateAI, Equals, Hevn, Crezco, Relace — all funded SaaS companies, all shipped by a solo specialist (me). The constraint isn't capacity; it's scope. If your project needs 50 pages, dozens of stakeholders, and a brand strategist, hire an agency.",
    },
    {
