    ...
    <>
      <main id="main-content" className="min-h-screen bg-[#ffffff] text-[#0a0a0a] selection:bg-[#0a0a0a]/30 selection:text-black font-sans relative overflow-hidden">
        ...
        <div className="fixed inset-0 -z-10">
          ...
          <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#0a0a0a]/2 rounded-full blur-3xl" />
          <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#0a0a0a]/2 rounded-full blur-3xl" />
        </div>
          ...
          <div className="max-w-container border-l border-[#e5e5e5] relative">
            ...
            <GridContainer cols={1}>
              <GridItem className="border-t py-16 md:py-20" padding={false}>
                ...
                >
                  {/* Avatar */}
                  <div className="w-20 h-20 bg-[#fafafa] rounded-full overflow-hidden border border-[#e5e5e5] flex items-center justify-center mb-6">
                    <Image
                      src="/favicon.svg"
                      alt="Rashid Iqbal"
                      width={48}
                  ...
                  <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#e5e5e5] bg-[#fafafa] text-[#0a0a0a] text-xs font-medium mb-5"
                  >
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#8b7cf8] opacity-75" />
                  ...
                  {/* Name */}
                  <h1 className="text-3xl md:text-5xl font-semibold tracking-tighter text-[#0a0a0a] mb-3 leading-[1.1] pb-1">
                  ...
                  {/* Description */}
                  <p className="text-base md:text-lg text-[#737373] max-w-md mx-auto leading-relaxed">
            ...
            <GridContainer cols={1}>
              ...
              >
                <GridItem className="bg-linear-to-b from-[#fafafa]/60 to-white ring-2 ring-[#0a0a0a]/30 ring-inset relative">
                  <a
                  ...
                  >
                    <div className="w-12 h-12 bg-[#0a0a0a] text-white flex items-center justify-center shrink-0">
                      {featuredLink.icon}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        <span className="text-[10px] font-mono text-[#0a0a0a] uppercase tracking-[0.2em]">
                          Featured · {featuredLink.label}
                        </span>
                      </div>
                      <h2 className="text-lg md:text-xl font-semibold text-[#0a0a0a] mb-1">
                        {featuredLink.name}
                      </h2>
                    ...
                    <ArrowUpRight className="w-5 h-5 text-[#0a0a0a] shrink-0 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                  </a>
                </GridItem>
              </motion.div>
            </GridContainer>
                    ...
                    <GridItem className="group h-full">
                      <div className="relative h-full flex flex-col">
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <span className="text-[10px] font-mono text-[#737373] uppercase tracking-[0.2em] mb-2 block">
                              {link.label}
                            </span>
                            <span className="font-medium text-[#0a0a0a] text-base block leading-tight mb-1 group-hover:text-[#0a0a0a] transition-colors">
                              {link.name}
                            </span>
                          ...
                          <ArrowUpRight
                            className="w-4 h-4 text-zinc-300 shrink-0 group-hover:text-[#0a0a0a] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all"
                            aria-hidden="true"
                          />
                        </LinkComponent>
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 w-7 h-7 flex items-center justify-center text-[#737373] hover:text-[#0a0a0a] hover:bg-[#fafafa] transition-colors opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0a0a0a]"
                          title="Copy link"
