...
export const metadata: Metadata = {
  ...
  description:
    "Hire a Certified Framer Expert for YC startups. Demo-day-ready landing pages in 2 weeks. Clients: UpdateAI, Vanos AI, SpaceDome, ATQLeads, Karumi, Keel.",
  keywords: [
...
const config: IndustryConfig = {
  ...
  intro:
    "Demo day is in two weeks and your landing page is still last batch's. I ship YC-grade marketing sites in 14 days — copy, design, build, launch. Past YC clients include UpdateAI, Vanos AI, SpaceDome, ATQLeads, Karumi, and Keel.",
  clients: ["UpdateAI", "Vanos AI", "SpaceDome", "ATQLeads", "Karumi", "Keel", "Circleback"],
  deliverables: [
