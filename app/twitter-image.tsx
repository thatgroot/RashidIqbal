...
export const alt = 'Rashid Iqbal - Figma & Framer Expert. Book a Free Call.';
export const size = {
  width: 1200,
  height: 630,
};
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <span style={{ fontSize: '22px', fontWeight: 600, color: '#e4e4e7' }}>Rashid Iqbal</span>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <p style={{ fontSize: '26px', color: '#a1a1aa', margin: 0, lineHeight: 1.4, maxWidth: '700px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              {['Figma', 'Framer', 'Chrome Extensions'].map((tag) => (
                <div
                  key={tag}
                  style={{
                    padding: '8px 18px',
