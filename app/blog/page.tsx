    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Rashid Iqbal Blog - Web Development Insights",
      },
    ],
  },
  twitter: {
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.map(({ tag, count }) => (
                    <Link
                      ...
                      className="px-3 py-1.5 bg-zinc-100 text-zinc-700 text-sm rounded hover:bg-orange-100 hover:text-orange-700 transition-colors"
                    >
                      {tag} ({count})
                    </Link>
                  ))}
