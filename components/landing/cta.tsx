        ...
        <div className="max-w-container border-l border-[#e5e5e5]">
          <GridContainer cols={2}>
            <div className="border-b border-r border-[#e5e5e5] p-12 lg:p-24 flex flex-col justify-center">
              ...
              <p className="text-lg text-[#737373] mt-6 max-w-md">
            ...
            <div className="border-b border-r border-[#e5e5e5] p-12 lg:p-24 relative overflow-hidden dotted-bg">
              <div className="relative z-10 flex flex-col gap-6 max-w-md">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-sm text-[#737373]">
                    <Clock className="w-4 h-4 text-[#0a0a0a]" aria-hidden="true" />
                ...
                <a
                  ...
                  className="px-8 py-4 bg-[#0a0a0a] text-white text-sm font-bold hover:bg-[#0a0a0a] transition-colors flex items-center justify-center gap-2 w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0a0a0a] focus-visible:ring-offset-2"
                >
          ...
          <GridContainer cols={1}>
            <GridItem className="relative" padding={false}>
              <div className="px-6 md:px-12 pt-10 md:pt-14 pb-2 max-w-3xl">
                <p className="text-[0.625rem] font-mono text-[#0a0a0a] uppercase tracking-[0.22em] mb-3">
                  Pick a time
                </p>
                <h3 className="text-2xl md:text-4xl font-semibold text-[#0a0a0a] tracking-tight leading-tight mb-3">
                ...
                <p className="text-sm md:text-base text-[#737373]">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline decoration-[#fde8a3] underline-offset-4 hover:text-[#0a0a0a] transition-colors"
                  >
