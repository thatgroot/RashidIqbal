        ...
        <GridContainer>
          <GridItem className="py-16" padding={false}>
            <div className="px-8 sm:px-12 max-w-2xl">
              <motion.span
                className="text-[0.625rem] font-mono text-[#0a0a0a] uppercase tracking-[0.2em] block mb-4"
              ...
              <motion.h2
                className="text-3xl md:text-4xl font-semibold text-[#0a0a0a] tracking-tight leading-[1.15]"
              ...
              <motion.p
                className="text-base text-[#737373] mt-4 leading-relaxed"
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin:"-80px" }}
          ...
          {valueProps.map((item, i) => (
            ...
            >
              <GridItem className="h-full flex flex-col">
                <span className="text-xs font-mono text-[#0a0a0a] tracking-widest mb-6">
                  {item.number}
                </span>
                <h3 className="text-xl font-semibold text-[#0a0a0a] mb-3 leading-tight">
                  {item.title}
                </h3>
