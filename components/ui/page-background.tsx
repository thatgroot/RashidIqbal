...
export function PageBackground({
    ...
    return (
        <div className={`fixed inset-0 -z-10 ${className}`}>
            ...
            {variant ==="default" && (
                <>
                    <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#0a0a0a]/[0.02] rounded-full blur-3xl" />
                    <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#0a0a0a]/[0.02] rounded-full blur-3xl" />
                </>
            )}
            ...
            {variant ==="gradient" && (
                <>
                    <div className="absolute top-20 left-1/4 w-[600px] h-[600px] bg-[#0a0a0a]/[0.03] rounded-full blur-3xl" />
