  ...
  return (
    <AnimatePresence>
      {activeCTA && (
        ...
        >
          <div className="bg-white border border-zinc-200 shadow-xl p-5 relative">
            <button
              onClick={dismiss}
            ...
            <p className="text-sm font-medium text-zinc-900 mb-3 pr-6">
              {activeCTA.message}
            </p>
            ...
            <a
              ...
              onClick={dismiss}
              className="inline-flex items-center gap-2 px-4 py-2 bg-orange-600 text-white text-xs font-bold hover:bg-orange-700 transition-colors"
            >
