...
export const ONE_TIME_PLANS: PricingPlan[] = [
  {
    ...
    baseFeatures: [
      "Figma Design: Landing Page + 3 Pages -> $1,000",
      "Bring it to Framer -> $600",
  ...
  },
  {
    ...
    baseFeatures: [
      "Figma Design: 5-8+ Pages -> $2,000",
      "Bring it to Framer + CMS -> $1,500",
      "Blog + Content Management",
      "Performance + CRO Optimized"
    ],
  ...
  },
  {
    ...
    baseFeatures: [
      "UX/UI Design: Extension Flow -> $1,000",
      "React + Mv3 Development -> $1,500",
